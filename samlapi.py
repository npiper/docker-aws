...
# Docker - expect an ENV variable with the federated Qualified domain name
if "FQDN" in os.environ:
   fqdn = os.environ["FQDN"]
else:
   print "Error - Environment variable 'FQDN' must be set to domain address of AWS SAML URL"
   quit()
